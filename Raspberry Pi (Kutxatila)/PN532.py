...
class PN532:
    ...
    def __connected(self, tag):
        self.device_uid = self.tagHandler.handle(tag)
        return True
    ...
    def listen(self):
        try:
            ...
            print(e)
            print(f"Error reason code (errno): {e.errno}")
...
class TagHandler:
    ...
    def __byteArrayToHexString(self, bArray):
        return binascii.hexlify(bytearray(bArray)).decode('utf-8').upper()
    ...
    def handle(self, tag):
        ...
        # detect type4a tags: smartphone
             ...
             return self.handleType4ATag(tag)
        else:
